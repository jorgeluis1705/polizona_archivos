    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-12 align-self-center text-center p-4">
          <h1>Peña Real Jorge Luis Server 37 Polizona</h1>
          ...
          <select id="opciones">
            ...
            <option value="E">Cobro a credito</option></select
          ><br /><br />
          ...
          <script type="text/javascript">
            ...
            function establecerClima() {
              ...
              if (eleccion === "A") {
                ...
                parrafo.textContent =
                  "Porfavor, inserte el numero de total de productos terminados.";
                div.innerHTML =
                  '<form action="finProd.php" method="post"><fieldset><legend> Ingrese datos solicitados</legend><p><label>Numero de Empresa: <input type="int" name="idEmpresa" /></label></p><p><label>Total Productos Terminados: <input type="int" name="totProd" /></label></p><p><input type="submit" value="enviar"/></p></fieldset></form>';
                div.innerHTML;
              } else if (eleccion === "D") {
                ...
                parrafo.textContent =
                  "Inserte la mercancia que se desea comprar .";
                div.innerHTML =
                  '<form action="compraCred.php" method="post"><fieldset><legend> Ingrese datos solicitados</legend><p><label>Numero de Empresa: <input type="int" name="idEmpresa" /></label></p><p><label>Total de Mercancia a Comprar: <input type="int" name="totCompra" /></label></p><p><input type="submit" value="enviar"/></p></fieldset></form>';
                div.innerHTML;
              } else {
